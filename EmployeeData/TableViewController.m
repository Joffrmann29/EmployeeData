...
- (void)viewDidLoad
{
    ...
    for (NSDictionary *dictionary in employeesAsPropertyLists){
        EmployeeRecord *employeeRecord = [self employeeObjectForDictionary:dictionary];
...
-(NSDictionary *)employeeObjectsDict:(EmployeeRecord *)empRecord
{
    NSDictionary *dictionary = @{FIRST_NAME : empRecord.firstName, LAST_NAME : empRecord.lastName, WAGE : @(empRecord.wage), POSITION : empRecord.position, HIRE_DATE : empRecord.dateOfHire};
    return dictionary;
}

-(EmployeeRecord *)employeeObjectForDictionary:(NSDictionary *)dictionary
{
    EmployeeRecord *employeeObject = [[EmployeeRecord alloc] initWithData:dictionary];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete){
        ...
        for (EmployeeRecord *record in self.employeeObjects){
...
{
    EmployeeRecord *employeeObject = self.employeeObjects[fromIndexPath.row];
